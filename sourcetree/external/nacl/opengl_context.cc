...
OpenGLContext::OpenGLContext(pp::Instance* instance)
  ...
  assert(module);
  gles2_interface_ = static_cast<const struct PPB_OpenGLES2*>(module
...
bool OpenGLContext::MakeContextCurrent(pp::Instance* instance) {
  ...
  if (context_.is_null()) {
    int32_t attribs[] = { PP_GRAPHICS3DATTRIB_ALPHA_SIZE, 8,
        PP_GRAPHICS3DATTRIB_DEPTH_SIZE, 24, PP_GRAPHICS3DATTRIB_STENCIL_SIZE, 8,
        PP_GRAPHICS3DATTRIB_SAMPLES, 0, PP_GRAPHICS3DATTRIB_SAMPLE_BUFFERS, 0,
        PP_GRAPHICS3DATTRIB_WIDTH, size_.width(), PP_GRAPHICS3DATTRIB_HEIGHT,
        size_.height(), PP_GRAPHICS3DATTRIB_NONE };
